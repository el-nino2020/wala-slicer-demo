 ...
 */
public class MyJUnitEntryPoints {
    ...
    /**
     * Construct JUnit entrypoints for all the JUnit test methods of mainClass in the given scope.
     *
     * @throws IllegalArgumentException if cha is null
     */
    public static Iterable<Entrypoint> make(IClassHierarchy cha, String mainClass, boolean log) {
        ...
        for (IClass klass : cha) {
            ...
            if (reference.equals(ClassLoaderReference.Application)) {
                ...
                if (!klass.getName().toString().equals(mainClass)) {
                    continue;
                } else {
                    classFound = true;
                }
